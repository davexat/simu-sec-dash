    ...
    return (
        <DashboardLayout>
            <div className="space-y-6">
                <div>
                    <h1 className="text-3xl font-bold mb-2">Simulador de Escritorio</h1>
                    <p className="text-muted-foreground">
                        Simula la instalación de software en un equipo protegido. El sistema verificará las políticas
                        de seguridad configuradas en Firebase.
                    </p>
                </div>
